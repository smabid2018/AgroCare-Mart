...
public class PasswordEncryptionWithAes {
	 ...
	 * @return A byte array representing the randomly generated nonce.
	 */
	...
	/**
	 * Generates an AES secret key of the specified key size.
	 * 
	 * @param keysize The size of the AES secret key.
	...
	/**
	 * Derives an AES secret key from the provided password and salt.
	 * 
	...
	/**
	 * Encrypts the provided password using AES-GCM algorithm with a derived key.
	 * 
	 * @param username The username associated with the password.
	 * @param password The password to be encrypted.
	 * @return A base64 encoded string representing the encrypted password.
	 */
	...
	/**
	 * Decrypts the encrypted password using the provided username.
	 * 
